import { SignupInput } from "@kushagra_95/medium-common"
  ...
  return (
    <div className='h-screen flex justify-center flex-col '>
        ...
        <div className='flex justify-center'>
            ...
            <div className="pt-8">
            {type==="signup"?<LabelledInput label="Name" placeholder="Kushagra Nigam..." onChange={(e)=>{
                    setPostInputs({
                        ...postInputs,
                        name: e.target.value
                    })
            ...
            <LabelledInput label="Username" placeholder="xyz@domain.com" onChange={(e)=>{
                    setPostInputs({
                        ...postInputs,
